...
object ExplosionConfig {
    ...
    init {
        valuesFor[ExplosionType.BULLET] = ExplosionConfigData(0, Vector2(10.0f, 10.0f), 16, Assets.BULLET_EXPLOSION)
        valuesFor[ExplosionType.ROCKET] = ExplosionConfigData(25, Vector2(32.0f, 32.0f), 32, Assets.ROCKET_EXPLOSION)
